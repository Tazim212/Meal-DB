const data = [
    ...
    const cars = () =>{
        const gettingId = document.getElementById('car-section');
        const adding = document.createElement('div');
        adding.classList.add('cars');
        adding.innerHTML = `
        <div class="card">
        ...
        <div class="card-body">
          ...
          <button class ="btn btn-primary">Price:132</button>
        </div>
      </div>   
        <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Description: ${data[1].description}</p>
          <button class ="btn btn-primary">Price:221</button>
        </div>
      </div>   
            `
        gettingId.appendChild(adding);
    }
    cars();
